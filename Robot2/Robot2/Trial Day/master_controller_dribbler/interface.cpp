...
scan:
  ...
  while(1){
    scansensor();
    lcd.setCursor(10,0);lcd.print("A6");lcd.print(sens[0]);
    lcd.setCursor(16,1);lcd.print("A5");lcd.print(sens[1]);
    lcd.setCursor(10,3);lcd.print("A2");lcd.print(sens[2]);
    lcd.setCursor(1,1);lcd.print("A0");lcd.print(sens[3]);
    if(!tb_back){
      while(!tb_back){}
      goto awal;  
    }
